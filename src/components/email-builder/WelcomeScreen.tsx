...
import { starterTemplates, StarterTemplate } from '@/data/email-templates';
    ...
    <div className="flex-1 overflow-auto bg-canvas">
      <div className="mx-auto max-w-2xl px-6 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">Choose a starting point for your email template</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">Build your email block by block</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-sm font-semibold text-foreground">Upload HTML</p>
              <p className="text-xs text-muted-foreground mt-1">Import an existing HTML email</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">Describe your email and let AI build it</p>
            </div>
          </button>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-foreground">Or pick a starter template</h3>
          </div>

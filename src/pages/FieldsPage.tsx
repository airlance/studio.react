...
import { DEFAULT_FIELDS } from '@/components/fields/fieldsData';
import { FieldRow } from '@/components/fields/FieldRow';
import { CreateEditFieldModal } from '@/components/fields/CreateEditFieldModal';
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex items-start justify-between px-6 py-5 border-b border-border shrink-0">
                <div>
                    <h1 className="text-lg font-semibold text-foreground">Field Manager</h1>
                ...
                <Button
                    onClick={openCreate}
                    className="bg-accent hover:bg-accent/90 text-accent-foreground shrink-0 ml-4"
                    size="sm"
                >
